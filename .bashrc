...
alias debget='sudo apt-get install'
alias logout='killall gnome-session-binary'
...
alias pycharm='~/pycharm/pycharm-community-2016.2.2/bin/pycharm.sh &'
alias ali='sshpass -p 'Love@1212' ssh root@120.27.112.181'
